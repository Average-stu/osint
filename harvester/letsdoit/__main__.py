...
from letsdoit.discovery import *
from letsdoit.discovery import dnssearch, takeover, shodansearch
from letsdoit.discovery.constants import *
from letsdoit.lib import hostchecker
from letsdoit.lib import reportgraph
from letsdoit.lib import stash
from letsdoit.lib import statichtmlgenerator
...
async def start():
    parser = argparse.ArgumentParser(description='letsdoit is used to gather open source intelligence (OSINT) on a company or domain.')
    ...
    if args.source is not None:
        ...
        if set(engines).issubset(Core.get_supportedengines()):
            ...
            for engineitem in engines:
                if engineitem == 'baidu':
                    from letsdoit.discovery import baidusearch
                    try:
                    ...
                    from letsdoit.discovery import bingsearch
                    try:
                    ...
                    from letsdoit.discovery import bufferoverun
                    try:
                    ...
                    from letsdoit.discovery import certspottersearch
                    try:
                    ...
                    try:
                        from letsdoit.discovery import crtsh
                    ...
                    try:
                        from letsdoit.discovery import dnsdumpster
                    ...
                    from letsdoit.discovery import duckduckgosearch
                    ...
                    from letsdoit.discovery import exaleadsearch
                    ...
                    try:
                        from letsdoit.discovery import githubcode
                    ...
                    from letsdoit.discovery import googlesearch
                    ...
                    from letsdoit.discovery import hackertarget
                    ...
                    from letsdoit.discovery import huntersearch
                    ...
                    from letsdoit.discovery import intelxsearch
                    # Import locally or won't work.
                    try:
                    ...
                    from letsdoit.discovery import linkedinsearch
                    ...
                    from letsdoit.discovery import pentesttools
                    try:
                    ...
                    from letsdoit.discovery import projectdiscovery
                    try:
                    ...
                    from letsdoit.discovery import qwantsearch
                    ...
                    from letsdoit.discovery import rapiddns
                    try:
                    ...
                    from letsdoit.discovery import securitytrailssearch
                    try:
                    ...
                    from letsdoit.discovery import sublist3r
                    try:
                    ...
                    from letsdoit.discovery import spyse
                    try:
                    ...
                    from letsdoit.discovery import threatcrowd
                    try:
                    ...
                    from letsdoit.discovery import threatminer
                    try:
                    ...
                    from letsdoit.discovery import trello
                    # Import locally or won't work.
                    ...
                    from letsdoit.discovery import twittersearch
                    ...
                    from letsdoit.discovery import urlscan
                    try:
    ...
    if dnslookup is True:
        ...
        from letsdoit.discovery.dnssearch import (
    ...
    if len(args.screenshot) > 0:
        ...
        from letsdoit.screenshot.screenshot import ScreenShotter
    ...
    if filename != "":
        ...
        try:
            ...
            with open(filename, 'w+') as file:
                file.write('<?xml version="1.0" encoding="UTF-8"?><letsdoit>')
                for x in all_emails:
